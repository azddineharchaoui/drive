  ...
  <section id="offers" class="bg-white py-16">
    <div class="container mx-auto px-6 lg:px-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            $offers = Vehicule::listeVehicules();
                ...
                foreach ($offers as $offer) {
                    ...
                    <div class="bg-gray-50 rounded-lg shadow-lg hover:shadow-xl transition duration-300 overflow-hidden">
                        <div class="p-6">
                            ...
                            <p class="text-gray-600 mb-4"> <span class="text-yellow-500 font-bold">' . htmlspecialchars($offer['id_categorie']) . '</span></p>
...
<section id="features" class="py-16 bg-gray-50">
  ...
  <div class="container mx-auto px-6 lg:px-16 text-center">
    ...
    <p class="text-lg text-gray-700 mb-8">
      Drive & Loc répond aux besoins variés de nombreux voyageurs, en rendant chaque expérience unique et mémorable.
    </p>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg">
