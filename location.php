...
<body class="bg-gradient-to-b from-blue-50 via-white to-gray-100 font-sans">
    ...
    <section id="mes-reservations" class="py-16 bg-gray-50">
      ...
      if (!empty($reservs)) {
        ...
        echo '<p class="text-center text-gray-600">Vous n\'avez aucune réservation pour le moment pour le moment.</p>';
      }
      ?>
...
<button onclick="showReservationPopup(<?php echo $offer[\'id_vehicule\']; ?>)">Réservez Maintenant</button>
    ...
    Swal.fire({
        title: 'Réservation',
        html: `
            <input type="hidden" id="id_voiture" value="${idVehicule}">
            <input type="date" id="date_debut" class="swal2-input" placeholder="Date de début" required>
            <input type="date" id="date_fin" class="swal2-input" placeholder="Date de fin" required>
            <input type="text" id="lieu_depart" class="swal2-input" placeholder="Lieu de départ" required>
            <input type="text" id="lieu_retour" class="swal2-input" placeholder="Lieu de retour" required>
        `,
        showCancelButton: true,
        confirmButtonText: 'Réserver',
        preConfirm: () => {
            const id_voiture = document.getElementById('id_voiture').value;
            const date_debut = document.getElementById('date_debut').value;
            const date_fin = document.getElementById('date_fin').value;
            const lieu_depart = document.getElementById('lieu_depart').value;
            const lieu_retour = document.getElementById('lieu_retour').value;
